...
s = 0
def simulate_movement(current_block):
    global s
    ...
    while is_in_bounds(player_loc):
        ...
        if is_in_bounds(next_possible_pos) and (map[next_possible_pos[1]][next_possible_pos[0]] == "#" or (next_possible_pos[1] == current_block[1] and next_possible_pos[0] == current_block[0])):
